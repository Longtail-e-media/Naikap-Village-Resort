...
<?php elseif (isset($_GET['mode']) && $_GET['mode'] == "addEdit"):
    if (isset($_GET['id']) && !empty($_GET['id'])):
        ...
        $vertical_dimensions = ($popupInfo->position == 1) ? "Image Dimensions ( 900 px X 1200 px)" : "";
        $horizontal = ($popupInfo->position == 2) ? "checked" : " ";
        $horizontal_dimensions = ($popupInfo->position == 2) ? "Image Dimensions ( 900 px X 1200 px)" : " ";
        $square = ($popupInfo->position == 3) ? "checked" : " ";
        $square_dimensions = ($popupInfo->position == 3) ? "Image Dimensions ( 900 px X 1200 px)" : " ";
