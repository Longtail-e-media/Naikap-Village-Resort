        ...
        <div class="example-code">
            <form action="" class="col-md-12 center-margin" id="testimonial_frm">
                ...
                <div class="form-row">
                    ...
                    <div class="form-input col-md-6">
                        <input placeholder="Link" class="col-md-6 " type="text" name="country" id="country"
                ...
                <div class="form-row">
                    ...
                    <div class="form-input col-md-6">
                        <input placeholder="Country" class="col-md-6 " type="text" name="via_type" id="via_type"
               ...
               <!--  <div class="form-row">
                ...
                <div class="form-row">
                    ...
                    <div class="form-input col-md-10 uploader <?php echo !empty($testimonialInfo->image) ? "hide" : ""; ?>">
                        ...
                        <label>
                            <small>Image Dimensions (160 px X 160 px)</small>
                        </label>
                    </div>
