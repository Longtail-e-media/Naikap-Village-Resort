    ...
    <div class="example-code">
        <form action="" class="col-md-12 center-margin" id="Preference_frm">
            ...
            <div class="form-row">
                ...
                <?php if (!empty($PrefeRow->logo_upload_dark)): ?>
                    <div class="col-md-2" id="removeSavedimg10">
                        <div class="infobox info-bg">
                            <div class="button-group" data-toggle="buttons">
                            <span class="float-left">
                                <?php
                                if (file_exists(SITE_ROOT . "images/preference/" . $PrefeRow->logo_upload_dark)):
                                    $filesize = filesize(SITE_ROOT . "images/preference/" . $PrefeRow->logo_upload_dark);
                                    echo 'Size : ' . getFileFormattedSize($filesize);
                                endif;
                                ?>
                            </span>
                                <a class="btn small float-right" href="javascript:void(0);"
                                   onclick="deleteSavedPreferenceimage(10);">
                                    <i class="glyph-icon icon-trash-o"></i>
                                </a>
                            </div>
                            <img src="<?php echo IMAGE_PATH . 'preference/thumbnails/' . $PrefeRow->logo_upload_dark; ?>"
                                 style="width:100%"/>
                        </div>
                    </div>
                <?php endif; ?>
                <div class="form-input col-md-10 uploader2 <?php echo !empty($PrefeRow->logo_upload_dark) ? "hide" : ""; ?>">
                    <input type="file" name="logo_upload_dark" id="logo_upload_dark" class="transparent no-shadow">
                    <label>
                        <small>Image Dimensions (<?php echo Module::get_properties($moduleId, 'simgwidth'); ?> px
                            X <?php echo Module::get_properties($moduleId, 'simgheight'); ?> px)
                        </small>
                ...
                <!-- Upload user image preview -->
                <div id="preview_Image10"><input type="hidden" name="imageArrayname10" value="" class=""/></div>
            </div>
            ...
            <div class="form-row">
                ...
                <div class="form-input col-md-10 uploader4 <?php echo !empty($PrefeRow->twitter_upload) ? "hide" : ""; ?>">
                    ...
                    <label>
                        <small>Image Dimensions 1200 pxx 675px</small>
                    </label>
                </div>
                <!-- Upload user image preview -->
            ...
            <div class="form-row">
                ...
                <div class="form-input col-md-6">        
                    <textarea placeholder="Facebook Pixel Code" name="pixel_code" id="pixel_code" class=""><?php echo !empty($PrefeRow->pixel_code)?$PrefeRow->pixel_code:"";?></textarea>
                </div>                
            </div>
            ...
            <div class="form-row">
                ...
                <?php if (!empty($PrefeRow->default_image)): ?>
                    <div class="col-md-2" id="removeSavedimg50">
                        <div class="infobox info-bg">
                            <div class="button-group" data-toggle="buttons">
                            <span class="float-left">
                                <?php
                                if (file_exists(SITE_ROOT . "images/preference/default/" . $PrefeRow->default_image)):
                                    $filesize = filesize(SITE_ROOT . "images/preference/default/" . $PrefeRow->default_image);
                                    echo 'Size : ' . getFileFormattedSize($filesize);
                                endif;
                                ?>
                            </span>
                                <a class="btn small float-right" href="javascript:void(0);"
                                   onclick="deleteSavedPreferenceimage(50);">
                                    <i class="glyph-icon icon-trash-o"></i>
                                </a>
                            </div>
                            <img src="<?php echo IMAGE_PATH . 'preference/default/thumbnails/' . $PrefeRow->default_image; ?>"
                                 style="width:100%"/>
                            <input type="hidden" name="imageArrayname50"
                                   value="<?php echo $PrefeRow->default_image; ?>"/>
                        </div>
                    </div>
                <?php endif; ?>
                <div class="form-input col-md-10 uploader50 <?php echo !empty($PrefeRow->default_image) ? "hide" : ""; ?>">
                    <input type="file" name="default_image" id="default_image" class="transparent no-shadow">
                    <label>
                        <small>Image Dimensions 1200 pxx 675px</small>
                    </label>
                </div>
                <!-- Upload user image preview -->
                <div id="preview_Image50"></div>
            </div>
            ...
            <div class="form-row">
                ...
                <?php if (!empty($PrefeRow->contact_image)): ?>
                    <div class="col-md-2" id="removeSavedimg501">
                        <div class="infobox info-bg">
                            <div class="button-group" data-toggle="buttons">
                            <span class="float-left">
                                <?php
                                if (file_exists(SITE_ROOT . "images/preference/contact/" . $PrefeRow->contact_image)):
                                    $filesize = filesize(SITE_ROOT . "images/preference/contact/" . $PrefeRow->contact_image);
                                    echo 'Size : ' . getFileFormattedSize($filesize);
                                endif;
                                ?>
                            </span>
                                <a class="btn small float-right" href="javascript:void(0);"
                                   onclick="deleteSavedPreferenceimage(501);">
                                    <i class="glyph-icon icon-trash-o"></i>
                                </a>
                            </div>
                            <img src="<?php echo IMAGE_PATH . 'preference/contact/thumbnails/' . $PrefeRow->contact_image; ?>"
                                 style="width:100%"/>
                            <input type="hidden" name="imageArrayname501"
                                   value="<?php echo $PrefeRow->contact_image; ?>"/>
                        </div>
                    </div>
                <?php endif; ?>
                <div class="form-input col-md-10 uploader501 <?php echo !empty($PrefeRow->contact_image) ? "hide" : ""; ?>">
                    <input type="file" name="contact_image" id="contact_image" class="transparent no-shadow">
                    <label>
                        <small>Image Dimensions 1200 pxx 675px</small>
                    </label>
                </div>
                <!-- Upload user image preview -->
                <div id="preview_Image501"></div>
            </div>
            ...
            <div class="form-row">
                ...
                <?php if (!empty($PrefeRow->gallery_image)): ?>
                    <div class="col-md-2" id="removeSavedimg502">
                        <div class="infobox info-bg">
                            <div class="button-group" data-toggle="buttons">
                            <span class="float-left">
                                <?php
                                if (file_exists(SITE_ROOT . "images/preference/gallery/" . $PrefeRow->gallery_image)):
                                    $filesize = filesize(SITE_ROOT . "images/preference/gallery/" . $PrefeRow->gallery_image);
                                    echo 'Size : ' . getFileFormattedSize($filesize);
                                endif;
                                ?>
                            </span>
                                <a class="btn small float-right" href="javascript:void(0);"
                                   onclick="deleteSavedPreferenceimage(502);">
                                    <i class="glyph-icon icon-trash-o"></i>
                                </a>
                            </div>
                            <img src="<?php echo IMAGE_PATH . 'preference/gallery/thumbnails/' . $PrefeRow->gallery_image; ?>"
                                 style="width:100%"/>
                            <input type="hidden" name="imageArrayname502"
                                   value="<?php echo $PrefeRow->gallery_image; ?>"/>
                        </div>
                    </div>
                <?php endif; ?>
                <div class="form-input col-md-10 uploader502 <?php echo !empty($PrefeRow->gallery_image) ? "hide" : ""; ?>">
                    <input type="file" name="gallery_image" id="gallery_image" class="transparent no-shadow">
                    <label>
                        <small>Image Dimensions 1200 pxx 675px</small>
                    </label>
                </div>
                <!-- Upload user image preview -->
                <div id="preview_Image502"></div>
            </div>

            <div class="form-row">
                <div class="form-label col-md-2">
                    <label for="">
                        Facilities Banner Image :
                    </label>
                </div>

                <?php if (!empty($PrefeRow->facilities_image)): ?>
                    <div class="col-md-2" id="removeSavedimg503">
                        <div class="infobox info-bg">
                            <div class="button-group" data-toggle="buttons">
                            <span class="float-left">
                                <?php
                                if (file_exists(SITE_ROOT . "images/preference/facilities/" . $PrefeRow->facilities_image)):
                                    $filesize = filesize(SITE_ROOT . "images/preference/facilities/" . $PrefeRow->facilities_image);
                                    echo 'Size : ' . getFileFormattedSize($filesize);
                                endif;
                                ?>
                            </span>
                                <a class="btn small float-right" href="javascript:void(0);"
                                   onclick="deleteSavedPreferenceimage(503);">
                                    <i class="glyph-icon icon-trash-o"></i>
                                </a>
                            </div>
                            <img src="<?php echo IMAGE_PATH . 'preference/facilities/thumbnails/' . $PrefeRow->facilities_image; ?>"
                                 style="width:100%"/>
                            <input type="hidden" name="imageArrayname503"
                                   value="<?php echo $PrefeRow->facilities_image; ?>"/>
                        </div>
                    </div>
                <?php endif; ?>
                <div class="form-input col-md-10 uploader503 <?php echo !empty($PrefeRow->facilities_image) ? "hide" : ""; ?>">
                    <input type="file" name="facilities_image" id="facilities_image" class="transparent no-shadow">
                    <label>
                        <small>Image Dimensions 1200 pxx 675px</small>
                    </label>
                </div>
                <!-- Upload user image preview -->
                <div id="preview_Image503"></div>
            </div>
    ...
    $(document).ready(function () {
        ...
        $('#logo_upload_dark').uploadify({
            ...
            'onUploadSuccess': function (file, data, response) {
                $('#uploadedImageName').val('1');
                var filename = data;
                $.post('<?php echo BASE_URL;?>apanel/preference/uploaded_image10.php', {imagefile: filename}, function (msg) {
                    $('#preview_Image10').html(msg).show();
                });
        ...
        $('#default_image').uploadify({
            'swf': '<?php echo ASSETS_PATH;?>uploadify/uploadify.swf',
            'uploader': '<?php echo ASSETS_PATH;?>uploadify/uploadify.php',
            'formData': {
                PROJECT: '<?php echo SITE_FOLDER;?>',
                targetFolder: 'images/preference/default/',
                thumb_width: 200,
                thumb_height: 200
            },
            'method': 'post',
            ...
            'onUploadSuccess': function (file, data, response) {
                $('#uploadedImageName').val('1');
                var filename = data;
                $.post('<?php echo BASE_URL;?>apanel/preference/uploaded_default_image.php', {imagefile: filename}, function (msg) {
                    $('#preview_Image50').html(msg).show();
                });
        ...
        //For contact image upload
        $('#contact_image').uploadify({
            'swf': '<?php echo ASSETS_PATH;?>uploadify/uploadify.swf',
            'uploader': '<?php echo ASSETS_PATH;?>uploadify/uploadify.php',
            'formData': {
                PROJECT: '<?php echo SITE_FOLDER;?>',
            ...
            'onUploadSuccess': function (file, data, response) {
                ...
                $.post('<?php echo BASE_URL;?>apanel/preference/uploaded_contact_image.php', {imagefile: filename}, function (msg) {
                    $('#preview_Image501').html(msg).show();
                });
        ...
        $('#gallery_image').uploadify({
            ...
            'onUploadSuccess': function (file, data, response) {
                ...
                $.post('<?php echo BASE_URL;?>apanel/preference/uploaded_gallery_image.php', {imagefile: filename}, function (msg) {
                    $('#preview_Image502').html(msg).show();
                });
        ...
        //For facilities image upload
        $('#facilities_image').uploadify({
            'swf': '<?php echo ASSETS_PATH;?>uploadify/uploadify.swf',
            'uploader': '<?php echo ASSETS_PATH;?>uploadify/uploadify.php',
            'formData': {
                PROJECT: '<?php echo SITE_FOLDER;?>',
                targetFolder: 'images/preference/facilities/',
                thumb_width: 200,
                thumb_height: 200
            },
            'method': 'post',
            ...
            'onUploadSuccess': function (file, data, response) {
                $('#uploadedImageName').val('1');
                var filename = data;
                $.post('<?php echo BASE_URL;?>apanel/preference/uploaded_facilities_image.php', {imagefile: filename}, function (msg) {
                    $('#preview_Image503').html(msg).show();
                });
