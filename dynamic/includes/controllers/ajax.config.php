<?php 
	...
	{		
		case "add":	
			...
			$record->logo_upload_dark		= $_REQUEST['imageArrayname10'];
			...
			$record->contact_image = (!empty($_REQUEST['imageArrayname501'])) ? $_REQUEST['imageArrayname501'] : '';
			$record->gallery_image = (!empty($_REQUEST['imageArrayname502'])) ? $_REQUEST['imageArrayname502'] : '';
		...
		case "edit":
			...
			if(!empty($_REQUEST['imageArrayname10'])):
				$record->logo_upload_dark		= $_REQUEST['imageArrayname10'];
			endif;
			...
			$record->default_image = (!empty($_REQUEST['imageArrayname50'])) ? $_REQUEST['imageArrayname50'] : '';
			
			$record->contact_image = (!empty($_REQUEST['imageArrayname501'])) ? $_REQUEST['imageArrayname501'] : '';
			$record->gallery_image = (!empty($_REQUEST['imageArrayname502'])) ? $_REQUEST['imageArrayname502'] : '';
			$record->facilities_image = (!empty($_REQUEST['imageArrayname503'])) ? $_REQUEST['imageArrayname503'] : '';
