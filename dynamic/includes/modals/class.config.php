...
class Config extends DatabaseObject
{
    ...
    protected static $table_name = "tbl_configs";
        protected static $db_fields = array('id', 'sitetitle', 'icon_upload', 'logo_upload', 'logo_upload_dark','fb_upload', 'twitter_upload', 'sitename', 'location_type', 'location_map', 'location_image', 'fiscal_address', 'mail_address', 'contact_info', 'address', 'email_address', 'breif', 'copyright', 'meta_title', 'site_keywords', 'site_description', 'google_anlytics', 'fb_messenger', 'book_type', 'hotel_code', 'hotel_page', 'template', 'admin_template', 'headers', 'footer', 'search_box', 'robot_txt', 'search_result', 'action', 'linksrc','contact_info2', 'pixel_code', 'default_image', 'contact_image','gallery_image','facilities_image');
