<?php
class SocialNetworking extends DatabaseObject {

	protected static $table_name = "tbl_social_networking";
	protected static $db_fields = array('id', 'linksrc', 'title', 'image', 'status', 'sortorder', 'registered', 'icon');
	...
	// homepage social networking display
